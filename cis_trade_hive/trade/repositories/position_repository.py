...
class PositionRepository:
    ...
    SORTABLE_COLUMNS = {
        ...
        'portfolio_entity_group': 'p.entity_group',
        ...
        'security_quoted_unquoted': 's.quoted_unquoted',
        'isin':              'pos.isin',
        ...
        try:
            ...
            query = f"""
                SELECT
                    ...
                    p.entity_group AS portfolio_entity_group,
                    ...
                    s.quoted_unquoted AS security_quoted_unquoted,
